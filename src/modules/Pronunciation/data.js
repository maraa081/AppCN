...
Rappelle-toi : en japonais, c'est un accent de hauteur (平板式/起伏式). En chinois, chaque syllabe a son propre ton fixe.`,
        ...
        exercises: [
          ...
          // --- Nouveaux exercices avancés de discrimination ---
          {
            id: 'tone_discrim_1',
            type: 'listen_dictation',
            instruction: 'Écoute la syllabe et tape le pinyin avec le ton correct (ex: ma1, ma2, ma3, ma4, ma5)',
            listenText: 'mā',
            answer: 'ma1',
            altAnswers: ['mā', 'ma1', 'ma 1'],
            explanation: 'C\'était le 1er ton (haut et plat) : mā',
          },
          {
            id: 'tone_discrim_2',
            type: 'listen_dictation',
            listenText: 'mǎ',
            answer: 'ma3',
            altAnswers: ['mǎ', 'ma3', 'ma 3'],
            explanation: 'C\'était le 3e ton (creux) : mǎ',
          },
          {
            id: 'tone_discrim_3',
            type: 'choose_tone_triplet',
            instruction: 'Écoute ces trois syllabes. Laquelle a un ton différent des deux autres ?',
            listenTexts: ['mā', 'mā', 'mǎ'],
            correctIndex: 2,
            options: ['Syllabe 1', 'Syllabe 2', 'Syllabe 3'],
            explanation: 'Les deux premières sont au 1er ton (mā), la troisième est au 3e ton (mǎ).',
          },
          {
            id: 'tone_discrim_4',
            type: 'choose_tone_triplet',
            instruction: 'Écoute ces trois syllabes. Laquelle a un ton différent ?',
            listenTexts: ['má', 'mà', 'má'],
            correctIndex: 1,
            options: ['Syllabe 1', 'Syllabe 2', 'Syllabe 3'],
            explanation: 'La deuxième est au 4e ton (mà), les autres au 2e ton (má).',
          },
          {
            id: 'tone_pairs_1',
            type: 'audio_to_hanzi',
            instruction: 'Écoute le mot et choisis le bon caractère',
            listenText: 'mā',
            correctIndex: 0,
            options: ['妈 (maman)', '马 (cheval)', '骂 (insulter)', '麻 (chanvre)'],
            explanation: 'mā (1er ton) = 妈 = maman. 马 serait mǎ (3e ton).',
          },
        ],
      },
      {
